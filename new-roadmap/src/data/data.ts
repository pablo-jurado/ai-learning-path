    ...
    children: [
      ...
      },
      {
        ...
        children: [
          ...
          {
            name: "Enterprise Orchestration Frameworks",
            children: [
              {
          ...
          },
          {
            ...
            description:
              "Best practices for scaling agentic AI in enterprise environments, including security, monitoring, cost management, and responsible AI governance.",
            children: [
              {
                name: "Memory Infrastructure",
                description:
                  "Control over what an Agent remembers and learns, including short-term and long-term memory patterns, context management, and knowledge persistence.",
                sources: [
                  {
                    label: "TODO",
                    url: "#",
              ...
              },
              {
                name: "Identity",
                description:
                  "How to enable Agents to securely access resources (data, tools, etc.), including authentication, authorization, and identity management patterns.",
                sources: [
                  {
                    label: "TODO",
                    url: "#",
              ...
              },
              {
                name: "Observability",
                description:
                  "Ability to trace, debug, and monitor Agent performance, including logging, metrics, distributed tracing, and debugging workflows.",
                sources: [
                  {
                    label: "TODO",
                    url: "#",
              ...
              },
              {
                ...
                description:
                  "How to ensure Agents stay within defined boundaries set by the organization, including guardrails, compliance rules, and safety policies.",
                sources: [
                  {
                    label: "TODO",
                    url: "#",
              ...
              },
              {
                ...
                description:
                  "How to improve Agent performance through continuous improvement and quality scoring, including feedback loops, reward signals, and evaluation frameworks.",
                sources: [
                  {
                    label: "TODO",
                    url: "#",
